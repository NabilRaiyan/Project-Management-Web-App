                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <thead className="text-ts text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
                            <tr className="text-nowrap">
                                ...
                                <th className="px-1 py-5">
                                    <TextInput defaultValue={queryParams.name} className="w-80" placeholder="User Name" onBlur={e => searchFieldChanged('name', e.target.value)} onKeyPress={e => onKeyPress('name', e)} />
                                </th>
                                <th className="px-1 py-5">
                                    <TextInput defaultValue={queryParams.email} className="w-80" placeholder="User Email" onBlur={e => searchFieldChanged('name', e.target.value)} onKeyPress={e => onKeyPress('email', e)} />
                                </th>
                        ...
                        {users.data.map((user) => (
                            <tr key={user.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td className="px-1 py-2 text-nowrap"></td>
